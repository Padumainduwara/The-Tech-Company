...
private Employee employee;
    ...
    private void initComponents() {
        ...
        txtepfage = new javax.swing.JTextField();
        ...
        jLabel7.setText("Add Employee Details");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtepfno, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 438, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        .addComponent(txtepfage, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(71, 71, 71)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(txtdep, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE)
                                        .addComponent(txtdesig, javax.swing.GroupLayout.Alignment.LEADING)))))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txtepfage, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31))
                    .addComponent(txtepfno, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         if (txtepfno.getText().isEmpty() || txtname.getText().isEmpty() || txtepfage.getText().isEmpty() || txtadd.getText().isEmpty() || txtdep.getText().isEmpty()|| txtdesig.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Fields cannot be empty", "Add a new Employee", JOptionPane.WARNING_MESSAGE);
    } else {
        String EmpEPF = txtepfno.getText();
        String EmpName = txtname.getText();
        int EmpAge = Integer.parseInt(txtepfage.getText());
        String EmpAddress = txtadd.getText();
        String Dep = txtdep.getText();
        String Desig = txtdesig.getText();

        if (employee.isEPFNoExists(EmpEPF)) {
            JOptionPane.showMessageDialog(null, "Employee with this EPF number already exists. Please choose a different EPF number.", "Add a new Employee", JOptionPane.WARNING_MESSAGE);
        } else {
            if (employee.isValidDep(Dep)) {
                Employee newEmp = new Employee(EmpEPF, EmpName, EmpAge, EmpAddress, Dep, Desig);
                ...
                JOptionPane.showMessageDialog(null, "Invalid Department", "Add a new Employee", JOptionPane.WARNING_MESSAGE);
            }
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
                ...
                txtadd.setText(null);
                txtepfno.setText(null);
                txtname.setText(null);
                txtepfage.setText(null);
    ...
    private javax.swing.JTextField txtepfage;
